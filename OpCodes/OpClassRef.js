...
Bayrell.Lang.OpCodes.OpClassRef = function(__ctx)
{
...
Object.assign(Bayrell.Lang.OpCodes.OpClassRef.prototype,
{
	...
	{
		if (o instanceof use("Bayrell.Lang.OpCodes.OpClassRef"))
		{
			this.__op = o.__op;
...
module.exports.Bayrell.Lang.OpCodes.OpClassRef = Bayrell.Lang.OpCodes.OpClassRef;