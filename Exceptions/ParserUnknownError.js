...
Bayrell.Lang.Exceptions.ParserUnknownError = function(__ctx, s, code, context, prev)
{
	if (code == -1)
	{
	...
	use("Runtime.Exceptions.RuntimeException").call(this, __ctx, s, code, context, prev);
};
